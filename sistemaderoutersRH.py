...
# =========================================================
# ESTILO CSS - ESTILO RETRO-SYNTH (NADA DE FONDO BLANCO)
# =========================================================

st.markdown("""
<style>
/* Fondo general de la aplicación en morado profundo */
.stApp {
    background-color: #1a103c;
}

/* Títulos principales con efecto gradiente neón */
h1 {
    background: linear-gradient(90deg, #ff007f 0%, #ff00ff 50%, #00ffff 100%);
...
/* Contenedores sin fondo blanco, usando morado medio y bordes cian */
...
/* Botón llamativo rectangular con estética retro */
div.stButton > button {
...
# =========================================================
# DISTRIBUCIÓN EN LADOS (COLUMNAS DE CONFIGURACIÓN)
# =========================================================

col_formulario, col_tablas = st.columns([1, 1.2])
...
if st.button("Resolver Modelo de Optimización"):
    ...
    try:
        ...
        if res.success:
            ...
            # Bloque visual sin fondo blanco para destacar la métrica
            st.markdown(f"""
            <div style='background: linear-gradient(135deg, #ff007f 0%, #7000ff 100%); 
                        ...
                        border: 2px solid #00ffff; box-shadow: 4px 4px 0px #ffea00;'>
                <p style='margin:0; font-size: 14px; font-weight: bold; color: #ffea00 !important; letter-spacing: 1px;'>Beneficio Máximo</p>
                <h1 style='margin:5px 0; color: #ffffff !important; -webkit-text-fill-color: #ffffff !important; font-size: 40px !important;'>{round(-res.fun, 2):,}</h1>
            </div>
            """, unsafe_allow_html=True)
