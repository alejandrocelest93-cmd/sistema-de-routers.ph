...
variables = [
    "Router Hogar (Home)",
    "Router Oficina (SOHO)",
    "Router Empresarial (Edge)",
    "Core Backbone (Data Center)"
]
...
with col_izq:
    ...
    u1 = col_u1.number_input("Hogar", value=20)
    u2 = col_u2.number_input("Oficina", value=50)
    u3 = col_u3.number_input("Empresarial", value=90)
    u4 = col_u4.number_input("Core Backbone", value=150)
    ...
    for i, var in enumerate(variables):
        val = cols_sel[i].selectbox(f"V{i+1}", options=[0, 1], index=1, help=f"Tipo para {var}")
